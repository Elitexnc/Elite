...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        response = f"ʏᴏᴜ ᴀɪɴ'ᴛ ᴀɴ ᴏᴡɴᴇʀ💀! ᴏɴʟʏ @Elitenc ɪꜱ ꜱᴜᴘᴘᴏꜱᴇᴅ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ"
...
async def redeem(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if len(command) == 1:
        ...
        if key in keys:
            ...
            response = f"ɪɴᴠᴀʟɪᴅ ᴏʀ ᴇxᴘɪʀᴇᴅ ᴋᴇʏ!"
    else:
        response = f"ᴜꜱᴀɢᴇ: /redeem <key> ɪꜰ ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴏɴᴇ ʙᴜʏ ꜰʀᴏᴍ @Elitenc"
...
async def broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        response = "ʏᴏᴜ ᴀɪɴ'ᴛ ᴀɴ ᴏᴡɴᴇʀ💀! ᴏɴʟʏ @Elitenc ɪꜱ ꜱᴜᴘᴘᴏꜱᴇᴅ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ."
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    response = f(
        "Welcome to the Flooding Bot by OWNER- @Elitenc ...! Here are the available commands:\n\n"
        "Admin Commands:\n"
